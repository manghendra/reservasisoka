...
?>
        ...
        <head>
            ...
            <meta name="author" content="Suhendra Eka Putra :: @mang_hendra" />
            <title>Administrator :: Sistem Reservasi</title>
            ...
            <script type="text/javascript" src="module/admin.js"></script>
            <script type="text/javascript" src="module/side_bar.js"></script>
            <style type="text/css">
                @media print {
                    #toolBoxPrint, .displayNone {
                        display: none;
                    }
                }
        	</style>  
